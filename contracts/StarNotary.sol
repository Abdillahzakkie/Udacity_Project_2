...
contract StarNotary is ERC721 {
    ...
    function createStar(string memory _name, string memory symbol, uint256 _tokenId) public { // Passing the name and tokenId as a parameters
    ...
    function buyStar(uint256 _tokenId) public  payable {
        ...
        _transfer(ownerAddress, msg.sender, _tokenId); // We can't use _addTokenTo or_removeTokenFrom functions, now we have to use transferFrom
